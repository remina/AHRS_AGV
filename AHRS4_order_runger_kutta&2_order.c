...
//float SEq_1_1 = 1.0f, SEq_2_1 = 0.0f, SEq_3_1 = 0.0f, SEq_4_1 = 0.0f;     //用于四阶龙格库塔
//float SEq_1_2 = 1.0f, SEq_2_2 = 0.0f, SEq_3_2 = 0.0f, SEq_4_2 = 0.0f;     //用于四阶龙格库塔
//float SEq_1_3 = 1.0f, SEq_2_3 = 0.0f, SEq_3_3 = 0.0f, SEq_4_3 = 0.0f;     //用于四阶龙格库塔
//float SEq_1_4 = 1.0f, SEq_2_4 = 0.0f, SEq_3_4 = 0.0f, SEq_4_4 = 0.0f;     //用于四阶龙格库塔
...
void AHRS_iteration(u8 type)
{
	...
	if(cal_ready)
	{
		...
		*/
		...
		/*
		//先迭代一次，保存f(xn+1,yn+1)
		SEq_1_1 = (-SEq_2 * gyro_x_f - SEq_3 * gyro_y_f * -1.0f - SEq_4 * gyro_z_f * -1.0f) * interval / 2.0f;
		SEq_2_1 = (SEq_1 * gyro_x_f + SEq_3 * gyro_z_f * -1.0f - SEq_4 * gyro_y_f * -1.0f) *  interval / 2.0f;
		SEq_3_1 = (SEq_1 * gyro_y_f * -1.0f - SEq_2 * gyro_z_f * -1.0f + SEq_4 * gyro_x_f) *  interval / 2.0f;
		SEq_4_1 = (SEq_1 * gyro_z_f * -1.0f + SEq_2 * gyro_y_f * -1.0f - SEq_3 * gyro_x_f) *  interval / 2.0f; 

		//先迭代两次
		SEq_1_2 = (-(SEq_2 + SEq_2_1 * 0.5) * gyro_x_f - (SEq_3 + SEq_3_1 * 0.5) * gyro_y_f * -1.0f - (SEq_4 + SEq_4_1 * 0.5) * gyro_z_f * -1.0f) * interval / 4.0f;
		SEq_2_2 = ((SEq_1 + SEq_1_1 * 0.5) * gyro_x_f + (SEq_3 + SEq_3_1 * 0.5) * gyro_z_f * -1.0f - (SEq_4 + SEq_4_1 * 0.5) * gyro_y_f * -1.0f) *  interval / 4.0f;
		SEq_3_2 = ((SEq_1 + SEq_1_1 * 0.5) * gyro_y_f * -1.0f - (SEq_2 + SEq_2_1 * 0.5) * gyro_z_f * -1.0f + (SEq_4 + SEq_4_1 * 0.5) * gyro_x_f) *  interval / 4.0f;
		SEq_4_2 = ((SEq_1 + SEq_1_1 * 0.5) * gyro_z_f * -1.0f + (SEq_2 + SEq_2_1 * 0.5) * gyro_y_f * -1.0f - (SEq_3 + SEq_3_1 * 0.5) * gyro_x_f) *  interval / 4.0f; 	

		//先迭代三次
		SEq_1_3 = (-(SEq_2 + SEq_2_2 * 0.5) * gyro_x_f - (SEq_3 + SEq_3_2 * 0.5) * gyro_y_f * -1.0f - (SEq_4 + SEq_4_2 * 0.5) * gyro_z_f * -1.0f) * interval / 4.0f;
		SEq_2_3 = ((SEq_1 + SEq_1_2 * 0.5) * gyro_x_f + (SEq_3 + SEq_3_2 * 0.5) * gyro_z_f * -1.0f - (SEq_4 + SEq_4_2 * 0.5) * gyro_y_f * -1.0f) *  interval / 4.0f;
		SEq_3_3 = ((SEq_1 + SEq_1_2 * 0.5) * gyro_y_f * -1.0f - (SEq_2 + SEq_2_2 * 0.5) * gyro_z_f * -1.0f + (SEq_4 + SEq_4_2 * 0.5) * gyro_x_f) *  interval / 4.0f;
		SEq_4_3 = ((SEq_1 + SEq_1_2 * 0.5) * gyro_z_f * -1.0f + (SEq_2 + SEq_2_2 * 0.5) * gyro_y_f * -1.0f - (SEq_3 + SEq_3_2 * 0.5) * gyro_x_f) *  interval / 4.0f; 	

		//先迭代四次
		SEq_1_4 = (-(SEq_2 + SEq_2_3) * gyro_x_f - (SEq_3 + SEq_3_3) * gyro_y_f * -1.0f - (SEq_4 + SEq_4_3) * gyro_z_f * -1.0f) * interval / 2.0f;
		SEq_2_4 = ((SEq_1 + SEq_1_3) * gyro_x_f + (SEq_3 + SEq_3_3) * gyro_z_f * -1.0f - (SEq_4 + SEq_4_3) * gyro_y_f * -1.0f) *  interval / 2.0f;
		SEq_3_4 = ((SEq_1 + SEq_1_3) * gyro_y_f * -1.0f - (SEq_2 + SEq_2_3) * gyro_z_f * -1.0f + (SEq_4 + SEq_4_3) * gyro_x_f) *  interval / 2.0f;
		SEq_4_4 = ((SEq_1 + SEq_1_3) * gyro_z_f * -1.0f + (SEq_2 + SEq_2_3) * gyro_y_f * -1.0f - (SEq_3 + SEq_3_3) * gyro_x_f) *  interval / 2.0f; 	

		//输出微分解
		SEq_1 += (SEq_1_1 + 2 * SEq_1_2 + 2 * SEq_1_3 + SEq_1_4) / 6.0f;
		SEq_2 += (SEq_2_1 + 2 * SEq_2_2 + 2 * SEq_2_3 + SEq_2_4) / 6.0f;
		SEq_3 += (SEq_3_1 + 2 * SEq_3_2 + 2 * SEq_3_3 + SEq_3_4) / 6.0f;
		SEq_4 += (SEq_4_1 + 2 * SEq_4_2 + 2 * SEq_4_3 + SEq_4_4) / 6.0f;
		*/
